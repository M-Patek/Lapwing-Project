...
class AgentFactory:
    ...
    def create_agent(
        ...
        **kwargs,
        ...
        elif conversation_agent_choice == "lapwing_agent":
            # Lapwing Agent - uses BasicMemoryAgent with Lapwing LLM
            lapwing_settings = agent_settings.get("lapwing_agent", {})
            llm_provider = lapwing_settings.get("llm_provider", "lapwing_llm")
