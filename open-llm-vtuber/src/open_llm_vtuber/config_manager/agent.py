...
class BasicMemoryAgentConfig(I18nMixin, BaseModel):
    ...
    llm_provider: Literal[
        ...
        "groq_llm",
        "mistral_llm",
        "lapwing_llm",  # Added for Lapwing integration
...
class AgentSettings(I18nMixin, BaseModel):
    ...
    lapwing_agent: Optional[BasicMemoryAgentConfig] = Field(None, alias="lapwing_agent")
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "lapwing_agent": Description(
            en="Configuration for Lapwing agent", zh="Lapwing 代理配置"
        ),
    }
...
class AgentConfig(I18nMixin, BaseModel):
    ...
    conversation_agent_choice: Literal[
        "basic_memory_agent", "mem0_agent", "hume_ai_agent", "letta_agent", "lapwing_agent"
